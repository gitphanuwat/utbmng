...
$('.example_objects_as_tags > > input').tagsinput('add', { "value": 4 , "text": "Washington8"  , "continent": "America"   });
...
$('.example_tagclass > > input').tagsinput('add', { "value": 4 , "text": "Washington7"  , "continent": "America"   });
  ...
  .controller('CityTagsInputController',
    function CityTagsInputController($scope, $http) {
      ...
      $scope.cities = [
        ...
        { "value": 4 , "text": "Washington6"  , "continent": "America"   },
